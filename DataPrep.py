...
for i , row in train_news.iterrows():
    if ((str(train_news.iloc[:,0]) == "mostly-true") | (str(train_news.iloc[:,0]) == "half-true") | (str(train_news.iloc[:,0]) == "true")):
...
for i , row in test_news.iterrows():
    if ((str(test_news.iloc[:,0]) == "mostly-true") | (str(test_news.iloc[:,0]) == "half-true") | (str(test_news.iloc[:,0]) == "true")):
        test_news.iloc[:,0] = "true"
    else :
        test_news.iloc[:,0] = "false"
        
for i,row in test_news.iterrows():
    print(row)   

for i , row in valid_news.iterrows():
    if ((str(valid_news.iloc[:,0]) == "mostly-true" )| (str(valid_news.iloc[:,0]) == "half-true") | (str(valid_news.iloc[:,0]) == "true")):
        valid_news.iloc[:,0] ="true"
    else :
        valid_news.iloc[:,0] = "false"
