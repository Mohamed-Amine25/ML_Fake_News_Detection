...
#la sélection des fonctionnalités a été effectuée dans le module FeatureSelection.py. ici, nous allons créer des modèles en utilisant ces fonctionnalités pour prédiction

#D'abord on utilise la technique de sac à mots 

#construction de classificateurs en utilisant le naive bayes 
...
#construction de classificateurs en utilisant  logistic regression
...
#Construction du classificateur de Linear SVM 
...
"""sgd_pipeline = Pipeline([
        ...
        ('svm2_clf',SGDClassifier(loss='hinge', penalty='l2', alpha=1e-3, n_iter=5000))
        ])
...
"""sgd_pipeline_ngram = Pipeline([
         ...
         ('sgd_clf',SGDClassifier(loss='hinge', penalty='l2', alpha=1e-3, n_iter=5000))
         ])
